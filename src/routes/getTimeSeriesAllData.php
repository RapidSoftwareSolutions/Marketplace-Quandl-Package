...
$app->post('/api/Quandl/getTimeSeriesAllData', function ($request, $response) {
    ...
    $query_str = "https://www.quandl.com/api/v3/datasets/{$data['databaseCode']}/{$data['datasetCode']}.json";
